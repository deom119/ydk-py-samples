...
"""
Set configuration for model Cisco-IOS-XR-lib-keychain-cfg.

usage: gn-set-xr-lib-keychain-cfg-10-ydk.py [-h] [-v] device
...
if __name__ == "__main__":
    ...
    # keychains.yfilter = YFilter.replace
    # gnmi.set(provider, keychains)
