...
"""
Set configuration for model Cisco-IOS-XR-infra-infra-locale-cfg.

usage: gn-set-xr-infra-infra-locale-cfg-26-ydk.py [-h] [-v] device
...
if __name__ == "__main__":
    ...
    locale.yfilter = YFilter.replace
    gnmi.set(provider, locale)
