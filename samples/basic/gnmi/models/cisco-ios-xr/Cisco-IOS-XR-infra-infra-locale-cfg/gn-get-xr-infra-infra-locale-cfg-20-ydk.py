...
"""
Get data for model Cisco-IOS-XR-infra-infra-locale-cfg.

usage: gn-get-xr-infra-infra-locale-cfg-20-ydk.py [-h] [-v] device
...
if __name__ == "__main__":
    ...
    locale.yfilter = YFilter.read
    locale = gnmi.get(provider, locale)
