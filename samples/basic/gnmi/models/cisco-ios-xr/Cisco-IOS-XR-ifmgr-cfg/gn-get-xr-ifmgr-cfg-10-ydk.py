...
"""
Get data for model Cisco-IOS-XR-ifmgr-cfg.

usage: gn-get-xr-ifmgr-cfg-10-ydk.py [-h] [-v] device
...
if __name__ == "__main__":
    ...
    # global_interface_configuration.yfilter = YFilter.read
    # global_interface_configuration = gnmi.get(provider, global_interface_configuration)
