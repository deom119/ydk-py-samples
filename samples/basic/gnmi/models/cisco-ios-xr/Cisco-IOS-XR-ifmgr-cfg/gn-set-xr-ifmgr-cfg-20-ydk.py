...
"""
Set configuration for model Cisco-IOS-XR-ifmgr-cfg.

usage: gn-set-xr-ifmgr-cfg-20-ydk.py [-h] [-v] device
...
if __name__ == "__main__":
    ...
    global_interface_configuration.yfilter = YFilter.replace
    gnmi.set(provider, global_interface_configuration)
