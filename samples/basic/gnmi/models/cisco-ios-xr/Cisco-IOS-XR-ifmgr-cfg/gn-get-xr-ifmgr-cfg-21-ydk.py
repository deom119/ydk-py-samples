...
usage: gn-get-xr-ifmgr-cfg-21-ydk.py [-h] [-v] device
...
if __name__ == "__main__":
    ...
    interface_configurations.yfilter = YFilter.read
    interface_configurations = gnmi.get(provider, interface_configurations)
