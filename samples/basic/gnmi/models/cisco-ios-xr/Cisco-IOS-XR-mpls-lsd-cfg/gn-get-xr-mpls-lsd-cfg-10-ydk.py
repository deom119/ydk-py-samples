...
"""
Get data for model Cisco-IOS-XR-mpls-lsd-cfg.

usage: gn-get-xr-mpls-lsd-cfg-10-ydk.py [-h] [-v] device
...
if __name__ == "__main__":
    ...
    # mpls_lsd.yfilter = YFilter.read
    # mpls_lsd = gnmi.get(provider, mpls_lsd)
