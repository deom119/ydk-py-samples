...
"""
Set configuration for model Cisco-IOS-XR-mpls-lsd-cfg.

usage: gn-set-xr-mpls-lsd-cfg-10-ydk.py [-h] [-v] device
...
if __name__ == "__main__":
    ...
    # mpls_lsd.yfilter = YFilter.replace
    # gnmi.set(provider, mpls_lsd)
