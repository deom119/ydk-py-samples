...
"""
Get data for model Cisco-IOS-XR-shellutil-cfg.

usage: gn-get-xr-shellutil-cfg-20-ydk.py [-h] [-v] device
...
if __name__ == "__main__":
    ...
    host_names.yfilter = YFilter.read
    host_names = gnmi.get(provider, host_names)
