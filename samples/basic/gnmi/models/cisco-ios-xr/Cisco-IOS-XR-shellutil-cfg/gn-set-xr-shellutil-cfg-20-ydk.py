...
"""
Set configuration for model Cisco-IOS-XR-shellutil-cfg.

usage: gn-set-xr-shellutil-cfg-20-ydk.py [-h] [-v] device
...
if __name__ == "__main__":
    ...
    host_names.yfilter = YFilter.replace
    gnmi.set(provider, host_names)
