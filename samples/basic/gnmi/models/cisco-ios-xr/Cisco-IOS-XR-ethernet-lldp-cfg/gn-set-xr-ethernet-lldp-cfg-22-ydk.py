...
"""
Set configuration for model Cisco-IOS-XR-ethernet-lldp-cfg.

usage: gn-set-xr-ethernet-lldp-cfg-22-ydk.py [-h] [-v] device
...
if __name__ == "__main__":
    ...
    lldp.yfilter = YFilter.replace
    gnmi.set(provider, lldp)
