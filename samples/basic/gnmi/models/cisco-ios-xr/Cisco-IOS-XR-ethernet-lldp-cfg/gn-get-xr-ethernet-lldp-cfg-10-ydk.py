...
"""
Get data for model Cisco-IOS-XR-ethernet-lldp-cfg.

usage: gn-get-xr-ethernet-lldp-cfg-10-ydk.py [-h] [-v] device
...
if __name__ == "__main__":
    ...
    # lldp.yfilter = YFilter.read
    # lldp = gnmi.get(provider, lldp)
