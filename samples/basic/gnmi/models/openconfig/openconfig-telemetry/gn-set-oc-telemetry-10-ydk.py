...
"""
Set configuration for model openconfig-telemetry.

usage: gn-set-oc-telemetry-10-ydk.py [-h] [-v] device
...
if __name__ == "__main__":
    ...
    # telemetry_system.yfilter = YFilter.replace
    # gnmi.set(provider, telemetry_system)
