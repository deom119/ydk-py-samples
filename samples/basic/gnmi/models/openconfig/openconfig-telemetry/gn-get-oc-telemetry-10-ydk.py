...
"""
Get data for model openconfig-telemetry.

usage: gn-get-oc-telemetry-10-ydk.py [-h] [-v] device
...
if __name__ == "__main__":
    ...
    # telemetry_system.yfilter = YFilter.read
    # telemetry_system = gnmi.get(provider, telemetry_system)
